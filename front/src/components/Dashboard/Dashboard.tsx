  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        const nextMails = batches.flat().sort((a, b) => {
      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-950/95 backdrop-blur">
        <div className="flex h-16 items-center justify-between gap-4 px-4 sm:px-6">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-yellow-400 to-green-500 bg-clip-text text-transparent text-3xl font-Laila font-bold leading-tight">
              FlowRank
            </span>
          </button>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/80 p-4 backdrop-blur-sm">
          <section className="w-full max-w-md rounded-lg border border-white/10 bg-slate-900 p-6 shadow-2xl shadow-black/50">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">
              You will leave this FlowRank session and need to sign in again to access your
              mailboxes.
            </p>
      ...
      >
                    ...
                    return (
                      ...
                      >
                        <span className="min-w-0">
                          <span className="block truncate font-semibold">{mailboxLabel(link)}</span>
                          <span
        ...
        <main className="min-w-0 max-w-full bg-slate-900">
          ...
          <section
            ...
            style={
              {
                '--message-columns': `${mailListCollapsed ? 56 : mailListWidth}px minmax(0,1fr)`,
              } as React.CSSProperties
            }
          >
            {mailListCollapsed && (
